...
$inmueble_Anadir = new Contenido($_POST[idNuevo],$_POST[fechaAltaNuevo],$_POST[precioNuevo],$_POST[direccionNuevo],$_POST[operacionNuevo],$_POST[provinciaNuevo],$_POST[tipoNuevo],0,$_POST[descripcionNuevo],1);
